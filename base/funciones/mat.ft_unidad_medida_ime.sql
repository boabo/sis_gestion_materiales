...
BEGIN
	...
	/*********************************
 	#TRANSACCION:  'MAT_UM_INS'
 	#DESCRIPCION:	Insercion de registros
 	#AUTOR:		admin
 	#FECHA:		14-03-2017 16:18:47
	***********************************/

	if(p_transaccion='MAT_UDM_INS')then
	...
	/*********************************
 	#TRANSACCION:  'MAT_UDM_MOD'
 	#DESCRIPCION:	Modificacion de registros
 	#AUTOR:		admin
 	#FECHA:		14-03-2017 16:18:47
	***********************************/

	elsif(p_transaccion='MAT_UDM_MOD')then
	...
	/*********************************
 	#TRANSACCION:  'MAT_UDM_ELI'
 	#DESCRIPCION:	Eliminacion de registros
 	#AUTOR:		admin
 	#FECHA:		14-03-2017 16:18:47
	***********************************/

	elsif(p_transaccion='MAT_UDM_ELI')then

...
Class RSolicitudCompraBoARep extends Report {
	var $objParam;
    ...
    function write() {
        ...
        $pdf->Cell($width3+$width2, $height, $this->getDataSource()->getParameter('gerente'), $white, 0, 'L', true, '', 0, false, 'T', 'C');
        ...
        $pdf->Cell($width3+$width2, $height, $this->getDataSource()->getParameter('funcionario_rpc'), $white, 0, 'L', true, '', 0, false, 'T', 'C');
        $pdf->Ln();
       ...
       if($this->getDataSource()->getParameter('nombre_usuario_ai')!= ''&&$this->getDataSource()->getParameter('nombre_usuario_ai')!= 'NULL'){
        ...
        $pdf->SetFont('', '');
        $pdf->Cell($width3+$width2, $height,'ALMACENES COCHABAMBA'/*$this->getDataSource()->getParameter('lugar_entrega')*/, 0, 1, 'L', false, '', 0, false, 'T', 'C');
        ...
        $firma_gerente = $this->getDataSource()->getParameter('gerente');
        $cargo_gerente = $this->getDataSource()->getParameter('desc_cargo_gerente');

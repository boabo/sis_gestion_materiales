...
EOD;
        ...
        if ($im2 !== false) {
            header('Content-Type: image/png');
            imagepng($im2, dirname(__FILE__) . "/../../reportes_generados/".$this->objParam->getParametro('nombre_archivo2').".png");
            imagedestroy($im2);

        } else {
            echo 'An error occurred.';
        }
        $ur2 =  dirname(__FILE__) . "/../../reportes_generados/". $this->objParam->getParametro('nombre_archivo2') . ".png";

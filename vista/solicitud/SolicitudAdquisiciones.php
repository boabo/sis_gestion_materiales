    ...
    Phx.vista.SolicitudAdquisiciones = {
      ...
      fwidth:1410,
        ...
        constructor: function (config) {
            ...
            Phx.vista.SolicitudAdquisiciones.superclass.constructor.call(this, config);
        ...
        preparaMenu:function(n){
            ...
            var tb =this.tbar;
            Phx.vista.SolicitudAdquisiciones.superclass.preparaMenu.call(this,n);
        ...
        liberaMenu:function(){
            var tb = Phx.vista.SolicitudAdquisiciones.superclass.liberaMenu.call(this);
            if(tb){
                this.getBoton('sig_estado').disable();
        ...
        successSave:function(resp){
          Phx.vista.SolicitudAdquisiciones.superclass.successSave.call(this,resp);

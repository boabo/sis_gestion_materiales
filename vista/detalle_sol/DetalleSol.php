  ...
  bnew: true,
    ...
    liberaMenu: function() {
		...
		saveAjustes: function () {
				...
				Ext.Ajax.request({
						...
						params: {
								...
								'observacion_exclusion': me.formExcluir.getForm().findField('observacion_exclusion').getValue()
		...
		excluirItem: function () {
				...
				this.formExcluir.getForm().findField('observacion_exclusion').show();
				this.formExcluir.getForm().findField('observacion_exclusion').setValue(d.observacion_exclusion);

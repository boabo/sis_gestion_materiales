...
Phx.vista.UnidadMedida=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'u/m.codigo',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'u/m.descripcion',type:'string'},
				id_grupo:1,
				grid:true,
				form:true
		},
		...
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'u/m.estado_reg',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'Field',
				filters:{pfiltro:'u/m.id_usuario_ai',type:'numeric'},
				id_grupo:1,
				grid:false,
				form:false
		},
		{
			config:{
				...
				type:'TextField',
				filters:{pfiltro:'u/m.usuario_ai',type:'string'},
				id_grupo:1,
				grid:true,
				form:false
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'u/m.fecha_reg',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
		...
		},
		{
			config:{
				...
				type:'DateField',
				filters:{pfiltro:'u/m.fecha_mod',type:'date'},
				id_grupo:1,
				grid:true,
				form:false
		},
	...
	ActList:'../../sis_gestion_materiales/control/UnidadMedida/listarUnidadMedida',
	id_store:'id_unidad_medida',
	fields: [
		{name:'id_unidad_medida', type: 'numeric'},
		{name:'codigo', type: 'string'},
		{name:'descripcion', type: 'string'},
		{name:'tipo_unidad_medida', type: 'string'},

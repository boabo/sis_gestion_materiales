...
?>
<script>
    Phx.vista.ProveedorMateriales=Ext.extend(Phx.gridInterfaz,{

        constructor:function(config){
            this.maestro=config.maestro;
            //llama al constructor de la clase padre
            Phx.vista.ProveedorMateriales.superclass.constructor.call(this,config);
            this.init();
            ...
            this.addButton('rubro',{
                grupo:[0,1,2,3,4,5],
                text :'Añadir Rubro',
                iconCls : 'bfolder',
                disabled: false,
                handler : this.winRubro,
                tooltip : '<b>Rubro Proveedores,</b><br/><b>Nos permite definir rubros para los proveedores.</b>'
            });
        ...
        winRubro: function () {
            ...
            Phx.CP.loadWindows('../../../sis_gestion_materiales/vista/proveedor/Rubro.php',
                'Definir Rubros para los Proveedores',
                {
                    width: '60%',
                    height: '70%'
                },
        ...
        east:{
            url:'../../../sis_gestion_materiales/vista/proveedor/RubroProveedor.php',
            title:'Rubro Proveedores',
        ...
        onButtonEdit:function(){
            ...
            Phx.vista.ProveedorMateriales.superclass.onButtonEdit.call(this); //sobrecarga enable select
        ...
        {	var rec = this.getSelectedData();
            ...
            Phx.vista.ProveedorMateriales.superclass.preparaMenu.call(this,n);
            this.getBoton('rubro').enable();


        },

        liberaMenu:function(){
            var tb = Phx.vista.ProveedorMateriales.superclass.liberaMenu.call(this);
            if(tb){
                this.getBoton('rubro').disable();
